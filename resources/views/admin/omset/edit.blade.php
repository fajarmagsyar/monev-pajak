                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="/admin/omset/{{ $omsetRow->omset_id }}"
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                placeholder="Masukkan Nominal Penghasilan" value ="{{$omsetRow->nominal}}"class="form-control" id="userName" />
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="mb-3">
                                                ...
                                                placeholder="" value="{{$omsetRow->pajak}}"class="form-control" id="" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="text-end">
