                                        ...
                                        <table class="table mb-0">
                                            ...
                                            <tbody>
                                                @if (count($omsetRows) < 1)
                                                    <tr>
                                                        <td colspan="7" class="text-center">Data belum ada, silahkan
                                                            tambah
                                                            data</td>
                                                    </tr>
                                                @else
                                                    @foreach ($omsetRows as $key => $r)
                                                        <tr>
                                                            ...
                                                            <td class="text-end">Rp.{{ number_format($r->pajak) }}
                                                            </td>
                                                            <td>
