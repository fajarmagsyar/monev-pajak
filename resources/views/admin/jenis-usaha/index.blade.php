                                    ...
                                    <table class="table mb-0">
                                        <thead class="table-dark">
                                            <tr>
                                                ...
                                                <th class="text-center">PPN (Omset)</th>
                                                <th class="text-center">PPN (Akhir)</th>
                                        ...
                                        <tbody>
                                            ...
                                            @else
                                                @foreach ($jenisUsahaRows as $key => $r)
                                                    <tr>
                                                        <th scope="row" class="text-center">{{ $key = $key + 1 }}</th>
                                                        <td>{{ $r->nama_jenis_usaha }}</td>
                                                        <td class="text-center">{{ $r->ppn1 }}%</td>
                                                        <td class="text-center">{{ $r->ppn2 }}%</td>
                                                        <td>{{ $r->created_at }}</td>
                                                        <td>{{ $r->updated_at }}</td>
